...
function run() {
  ...
  assert.match(analyticsModule, /function ScrollTextTube/)
  ...
  assert.match(analyticsModule, /EVOLVE/)
  assert.match(analyticsModule, /INTERFACE/)
  assert.match(analyticsModule, /IMMERSION/)
  assert.match(analyticsModule, /VELOCITY/)
  assert.match(analyticsModule, /PRECISION/)
  assert.match(analyticsModule, /CRAFT/)
